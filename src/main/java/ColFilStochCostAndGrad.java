 ...
 */
public class ColFilStochCostAndGrad implements CostAndGrad {
    private double J;
    ...
    public ColFilStochCostAndGrad(DoubleMatrix params, DoubleMatrix Y, DoubleMatrix R, double lambda,
